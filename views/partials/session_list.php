        ...
        <a href="<?= $url ?>" class="list-group-item list-group-item-action session-item <?= $isActive ?> <?= $extraClass ?>">
            ...
            <div class="d-flex w-100 justify-content-between align-items-center">
                <h6 class="mb-1 text-truncate fw-bold" style="max-width: 60%;">
                    ...
                    <?php if ($isTransfAct): ?>
                        <span class="badge bg-danger text-white ms-1" style="font-size:0.6rem; vertical-align:middle; animation: pulse 1.5s infinite;"><i class="fas fa-headset"></i> ACTIVA</span>
                    <?php elseif ($tieneTransf): ?>
                        <span class="badge bg-warning text-dark ms-1" style="font-size:0.55rem; vertical-align:middle;" title="Transferida"><i class="fas fa-headset"></i></span>
                    <?php endif; ?>
                    <?php if ($tieneTicket): ?>
                        <span class="badge bg-info text-dark ms-1" style="font-size:0.55rem; vertical-align:middle;" title="Con Ticket"><i class="fas fa-ticket-alt"></i></span>
                    <?php endif; ?>
                </h6>
