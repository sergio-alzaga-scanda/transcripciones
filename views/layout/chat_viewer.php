...
<html lang="es">
<head>
    <title>Conversaciones - VF Analytics</title>
                ...
                <div class="list-group list-group-flush">
                    <?php if (empty($sessions)): ?>
                        <div class="p-4 text-center text-muted">
                            <i class="fas fa-filter fa-2x mb-2 opacity-50"></i><br>Sin resultados.
                        </div>
                    <?php else: ?>
            ...
            <div class="col-md-8 col-lg-9 chat-area">
                <?php if ($currentSession): ?>
                    <?php
                        ...
                        // C) Formato Badge Amarillo
                        // CORRECCIÓN AQUÍ: Convertir a (int) antes del módulo % para evitar el error Deprecated
                        $minTotal = floor($totalSeconds / 60);
                        $secTotal = (int)$totalSeconds % 60; // <--- SE AGREGÓ (int)
                        ...
                        <?php 
                            ...
                            foreach($messages as $msg): 
                                ...
                                if ($prevTime !== null) {
                                    ...
                                    // CORRECCIÓN AQUÍ: Convertir a (int) antes del módulo %
                                    if ($diff < 60) {
                                        $str = $diff . "s";
                                    } else {
                                        $str = floor($diff / 60) . "m " . ((int)$diff % 60) . "s"; // <--- SE AGREGÓ (int)
                                    }
