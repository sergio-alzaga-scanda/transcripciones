...
$hasFilters = !empty($filter_user_number) || !empty($filter_projectID) || !empty($filter_sessionID) || !empty($filter_fecha);
$where_sql = $where_conditions ? 'WHERE '. implode(' AND ', $where_conditions) : '';

$resumen_result = null;
if ($hasFilters) {
    $resumen_sql = "SELECT user_number, projectID, sessionID, status 
...
if ($selected_user_number) {
    ...
    $html_sql = "
        SELECT html, status 
        FROM conversaciones_html 
        WHERE user_number = '$user_number_safe'
    ";
        ...
        while ($row = $html_res->fetch_assoc()) {
            ...
            foreach ($items as $item) {
                ...
                if ($smallTags->length > 0) {
                    ...
                    $li_html_decoded = preg_replace_callback('/\\\\u([0-9a-fA-F]{4})/', function($m) {
                        return mb_convert_encoding(pack('H*', $m[1]), 'UTF-8', 'UCS-2BE');
                    }, $li_html);
                    // Reemplazar claves específicas por valores deseados
...
$usuarioIcono = '<img src="data:image/png;base64," style="width:24px;height:24px;" />';
                    ...
                    $li_html_decoded = str_replace('agenteIconoProd', $agenteIcono, $li_html_decoded);
                    $li_html_decoded = str_replace('usuarioIconoProd', $usuarioIcono, $li_html_decoded);

                    $all_li_items[] = [
                        'fechaHora' => $fechaHora,
                        'li_html' => $li_html_decoded
                    ];
                }
            }
        }
        ...
        <div class="col-md-4 border-end d-flex flex-column" id="conversations-list">
            <div class="p-2">
                ...
                <form method="GET" class="mb-3">
                    <input type="text" name="user_number" class="form-control mb-2" placeholder="Buscar por user_number" value="<?= htmlspecialchars($filter_user_number) ?>">
                        ...
                        <?php foreach ($conversaciones as $fecha => $datos): ?>
                            ...
                            <li class="list-group-item d-flex flex-column">
                                <div class="d-flex justify-content-between">
                                    <a href="?selected_user_number=<?= urlencode($row['user_number']) ?>&selected_date=<?= urlencode($fecha) ?>&user_number=<?= urlencode($filter_user_number) ?>&projectID=<?= urlencode($filter_projectID) ?>&sessionID=<?= urlencode($filter_sessionID) ?>&fecha=<?= urlencode($filter_fecha) ?>">
...
document.getElementById('range-select').addEventListener('change', function () {
    ...
    fetch(`http://127.0.0.1:5000/procesar_transcripts?range=${selected}`)
